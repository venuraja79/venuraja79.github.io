...
Except for Gangaikonda Cholapuram, all the other 3 temples are on the south river kaveri.

<div class="imgcap" align="center">
<img src="/images/chola/map_temples.png" height="50%" width="50%">
</div>
...
of Chola's reign it remained as its capital. You can't see any signs of it in Cholapuram, just the temple
and its ruins. 

Anyway, the focus shifts from size and grandeur to finesse at Darasuram and Thirubuvanam. The first two were
built during their ascendency (around 1000 AD) and the next two were built during the start of so called descendency
